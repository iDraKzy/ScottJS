	...
	constructor(client) {
		super(client, {
			...
			description: [
				{
					lang: "fr",
					text: "Affiche une liste de toutes les commandes disponibles, ou des informations détaillées sur une commande spécifique."
				},
				{
					lang: "en",
					text: "Displays a list of available commands, or detailed information for a specified command."
				}
			],
			details: oneLine`
